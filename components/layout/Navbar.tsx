...
import { CircleHelp, Menu, Orbit, Rocket, Tag, Users, Workflow } from 'lucide-react';
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-gray-200/70 bg-white/80 backdrop-blur-xl shadow-sm">
      <div className="mx-auto h-16 w-full max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 min-w-0">
          <Orbit className="h-4 w-4 text-gray-700" />
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8 text-sm font-medium text-gray-600">
          <Link href="/#how-it-works" className="inline-flex items-center gap-1.5 hover:text-gray-900 transition-colors"><Workflow className="h-3.5 w-3.5" />How It Works</Link>
          <Link href="/#use-cases" className="inline-flex items-center gap-1.5 hover:text-gray-900 transition-colors"><Users className="h-3.5 w-3.5" />Use Cases</Link>
          <Link href="/#faq" className="inline-flex items-center gap-1.5 hover:text-gray-900 transition-colors"><CircleHelp className="h-3.5 w-3.5" />FAQ</Link>
        ...
        <details className="md:hidden relative">
          ...
          <div className="absolute right-0 mt-2 w-52 rounded-xl border border-gray-200 bg-white p-2 shadow-xl">
            <Link href="/#how-it-works" className="inline-flex w-full items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"><Workflow className="h-3.5 w-3.5" />How It Works</Link>
            <Link href="/#use-cases" className="inline-flex w-full items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"><Users className="h-3.5 w-3.5" />Use Cases</Link>
            <Link href="/#faq" className="inline-flex w-full items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"><CircleHelp className="h-3.5 w-3.5" />FAQ</Link>
